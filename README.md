...
![Alt text](Doc/Benchmark/CPU_Timing_Quartz.png?raw=true "Code benchmark on Quartz CPU" | width=100)
![Alt text](Doc/Benchmark/CPU_Timing_Lassen.png?raw=true "Code benchmark on Lassen CPU" | width=100)
![Alt text](Doc/Benchmark/GPU_Timing_Lassen.png?raw=true "Code benchmark on Lassen GPU" | width=100)
