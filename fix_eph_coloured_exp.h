...
#ifdef FIX_CLASS
FixStyle(eph/coloured/exp,FixEPHColouredExp)
#else

#ifndef LMP_FIX_EPH_COLOURED_EXP_H
#define LMP_FIX_EPH_COLOURED_EXP_H
...
namespace LAMMPS_NS {
class FixEPHColouredExp : public Fix {
 public:
  ...
  FixEPHColouredExp(class LAMMPS *, int, char **); // constructor
  ~FixEPHColouredExp(); // destructor
